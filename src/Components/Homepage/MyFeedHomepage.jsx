        ...
        >
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="	https://img0.junaroad.com/images/icons/women/kurtas.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              KURTAS
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="	https://img0.junaroad.com/images/icons/women/tops.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              TOPS
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="	https://img0.junaroad.com/images/icons/women/dresses.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              DRESSES
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="	https://img0.junaroad.com/images/icons/women/sarees.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              SAREES
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="https://img0.junaroad.com/images/icons/women/suits.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              SUITS
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="https://img0.junaroad.com/images/icons/women/bottoms.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              BOTTOMS
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="	https://img0.junaroad.com/images/icons/women/bags.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              BAGS
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="	https://img0.junaroad.com/images/icons/women/footwear.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              FOOTWEAR
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="https://img0.junaroad.com/images/icons/women/kids.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              KIDS
            </Text>
          ...
          <Stack _hover={{ cursor: "pointer" }} align={"center"}>
            <Avatar
              size="md"
              name="Ryan Florence"
              src="https://img0.junaroad.com/images/icons/women/winter.png"
            />
            <Text fontWeight={"500"} fontSize={"9.5px"}>
              WINTER
            </Text>
